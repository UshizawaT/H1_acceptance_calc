...
class BaseConstruct : public TObject {
 public:
  ...
  virtual void SetGeometry(G4Box *solid);
  virtual void SetGeometry(G4Box *solid, G4LogicalVolume *_parent,
                           G4String color_name);
  virtual void SetGeometry(G4VBox *solid, G4LogicalVolume *_parent,
                           Scintillator *_scinti, G4String color_name);
...
inline G4VLogicalVolume *BaseConstruct::GetLogicalVol() { return logvol; }
